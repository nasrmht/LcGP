...
def run_benchmark(N=50, P_values=range(1, 11), n_repeats=5):
    ...
    results = {
        'P_values': P_values,
        'inversion_global_mean': [], 'inversion_global_std': [],
        'inversion_blocks_mean': [], 'inversion_blocks_std': [],
        'inversion_chol_global_mean': [], 'inversion_chol_global_std': [],
        'inversion_chol_blocks_mean': [], 'inversion_chol_blocks_std': [],
        'quad_global_mean': [], 'quad_global_std': [],
        'quad_blocks_mean': [], 'quad_blocks_std': [],
        'quad_chol_global_mean': [], 'quad_chol_global_std': [],
        'quad_chol_blocks_mean': [], 'quad_chol_blocks_std': []
    }
    ...
    for P in P_values:
        ...
        mean_time, std_time = benchmark_operation(invert_global_matrix, K_global, n_repeats=n_repeats)
        results['inversion_global_mean'].append(mean_time)
        results['inversion_global_std'].append(std_time)
        
        mean_time, std_time = benchmark_operation(invert_block_matrices, K_blocks, n_repeats=n_repeats)
        results['inversion_blocks_mean'].append(mean_time)
        results['inversion_blocks_std'].append(std_time)
        
        mean_time, std_time = benchmark_operation(cholesky_invert_global, K_global, n_repeats=n_repeats)
        results['inversion_chol_global_mean'].append(mean_time)
        results['inversion_chol_global_std'].append(std_time)
        
        mean_time, std_time = benchmark_operation(cholesky_invert_blocks, K_blocks, n_repeats=n_repeats)
        results['inversion_chol_blocks_mean'].append(mean_time)
        results['inversion_chol_blocks_std'].append(std_time)
        
        # Benchmark des formes quadratiques
        mean_time, std_time = benchmark_operation(quadratic_form_global, Y_global, K_global, n_repeats=n_repeats)
        results['quad_global_mean'].append(mean_time)
        results['quad_global_std'].append(std_time)
        
        mean_time, std_time = benchmark_operation(quadratic_form_blocks, Y_blocks, K_blocks, n_repeats=n_repeats)
        results['quad_blocks_mean'].append(mean_time)
        results['quad_blocks_std'].append(std_time)
        
        mean_time, std_time = benchmark_operation(quadratic_form_global_cholesky, Y_global, K_global, n_repeats=n_repeats)
        results['quad_chol_global_mean'].append(mean_time)
        results['quad_chol_global_std'].append(std_time)
        
        mean_time, std_time = benchmark_operation(quadratic_form_blocks_cholesky, Y_blocks, K_blocks, n_repeats=n_repeats)
        results['quad_chol_blocks_mean'].append(mean_time)
        results['quad_chol_blocks_std'].append(std_time)
...
def plot_results(results):
    ...
    ax1.errorbar(P_values, results['inversion_global_mean'], 
                yerr=results['inversion_global_std'], 
                label='Inversion globale (NP×NP)', marker='o', linewidth=2)
    ax1.errorbar(P_values, results['inversion_blocks_mean'], 
                yerr=results['inversion_blocks_std'], 
    ...
    ax2.errorbar(P_values, results['inversion_chol_global_mean'], 
                yerr=results['inversion_chol_global_std'], 
                label='Cholesky global (NP×NP)', marker='o', linewidth=2)
    ax2.errorbar(P_values, results['inversion_chol_blocks_mean'], 
                yerr=results['inversion_chol_blocks_std'], 
    ...
    ax3.errorbar(P_values, results['quad_global_mean'], 
                yerr=results['quad_global_std'], 
                label='Y^T @ K^-1 @ Y (global)', marker='o', linewidth=2)
    ax3.errorbar(P_values, results['quad_blocks_mean'], 
                yerr=results['quad_blocks_std'], 
    ...
    ax4.errorbar(P_values, results['quad_chol_global_mean'], 
                yerr=results['quad_chol_global_std'], 
                label='Y^T @ K^-1 @ Y (Cholesky global)', marker='o', linewidth=2)
    ax4.errorbar(P_values, results['quad_chol_blocks_mean'], 
                yerr=results['quad_chol_blocks_std'], 
...
if __name__ == "__main__":
    ...
    P_values = range(6, 16)  # Nombre de blocs à tester
    n_repeats = 100  # Nombre de répétitions pour chaque mesure
